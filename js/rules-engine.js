(function exposeRulesEngine(root, factory) {
  const api = factory();
  if (typeof module !== "undefined" && module.exports) module.exports = api;
  else root.DsgvoRulesEngine = api;
})(typeof globalThis !== "undefined" ? globalThis : this, function createRulesEngine() {
"use strict";
...
function evaluateChange(change, rules) {
  ...
  if (customerInformationRequired) {
    documents.push("Kundeninformation");
